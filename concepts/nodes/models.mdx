---
title: "Models"
description: "Configure generative models for use in the Prompt, Code and Media nodes"
---
...
The Media node will only display models from Fal. The Prompt and Code node will display all installed language models. 