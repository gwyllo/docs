...
Hover over the input parameter and double-click the `input` parameter name. Enter `image`. 
...
Double-click and create an Image node. Enter "a humback whale" as the prompt and press play. 
Now double-click and create a Describe Image node from your My Tools library. 
...
Create a new Prompt node and connect the output of your image node to the blue Context input. Enter "describe this image in detail" as the prompt. 
