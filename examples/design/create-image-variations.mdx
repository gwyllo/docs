...
<img src="/images/examples/imageVariations.png" style={{ borderRadius: "0.5rem" }} />
...
You can generate image variations using the setting on the Media node or by providing multiple prompts.
